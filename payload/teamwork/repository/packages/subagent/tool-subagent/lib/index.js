...
function apply(ctx, config) {
	...
	const install = (runtimeCtx, modelSelectionPolicy) => {
		...
		const mount = (subagentProvider) => {
			...
			const routingGuidance = config.routingGuidance === void 0 ? "" : ` ${config.routingGuidance}`;
